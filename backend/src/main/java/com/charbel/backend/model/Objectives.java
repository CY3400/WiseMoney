...
@Table(
    ...
    uniqueConstraints = {
        @UniqueConstraint(
            name = "uk_objectives_user_month_year",
            columnNames = {"user_id","month","year"}
        )
    },
    indexes = {
        @Index(name = "idx_objectives_user", columnList = "user_id")
    }
)
public class Objectives {
    ...
    @JoinColumn(name = "user_id", nullable = false, foreignKey = @ForeignKey(name = "fk_objectives_user"))
    private Users user;
